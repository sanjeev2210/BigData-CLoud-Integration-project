...
<body>
<form enctype="multipart/form-data" method="POST" action="http://www.thor.com/cgi-bin/run_2.py">
<h3>Mapper Reducer Job Submission:</h3>
<table>
<tr style="bottom:10px;">
<td>Reducer Program:</td>
...
fh1=open('/var/www/cgi-bin/uploads/red.py','w')
fh1.write(fname)
fh1.close()

print '<META HTTP-EQUIV=refresh CONTENT=\"0;URL=http://www.thor.com/cgi-bin/run_final.py\">\n'
