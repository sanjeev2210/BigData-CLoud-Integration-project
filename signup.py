...
<div class="logport">
<center>
<form method="POST" action="http://www.thor.com/cgi-bin/signup.py">
...
<tr>
<td colspan="2"><center>
<input type="submit" value="Register" style="width:120px;height:40px;color:blue;font-size:25px;background:lightgrey;border-radius:4px;"><b></b></center>
</td>
<td></td>
</tr>
</table>
...
commands.getstatusoutput('sshpass -p redhat ssh -o stricthostkeychecking=no root@{} sudo useradd {}'.format(ipServer,user))
commands.getstatusoutput("sshpass -p redhat ssh -o stricthostkeychecking=no root@{} sudo 'echo {} | passwd {} --stdin'".format(ipServer,passwd,user))

print '<META HTTP-EQUIV=refresh CONTENT=\"0;URL=http://www.thor.com/confirm.html">\n'
